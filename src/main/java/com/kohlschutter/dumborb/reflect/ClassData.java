...
public class ClassData {
   ...
   * @param staticMethodMap Map of public static methods. Key is a AccessibleObjectKey object, value
   ...
   */
  public ClassData(Class<?> clazz, Map<AccessibleObjectKey, Set<AccessibleObject>> methodMap,
      Map<AccessibleObjectKey, Set<AccessibleObject>> staticMethodMap,
      Map<AccessibleObjectKey, Set<AccessibleObject>> constructorMap) {
    this.clazz = clazz;
    this.methodMap = new HashMap<AccessibleObjectKey, Set<AccessibleObject>>(methodMap);
    this.methodMap.putAll(staticMethodMap);
    this.staticMethodMap = new HashMap<AccessibleObjectKey, Set<AccessibleObject>>(staticMethodMap);
    this.constructorMap = new HashMap<AccessibleObjectKey, Set<AccessibleObject>>(constructorMap);
  }
  ...
  /**
   * Get the Map of public methods (both static and non-static) that can be invoked for the class.
