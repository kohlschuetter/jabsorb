...
public class ProcessedObject {
  ...
  /**
   * The processed incoming object. When marshalling, this is the java object that is being
   * marshalled to json, when unmarshalling, this is the json object being marshalled to java.
   */
   ...
   *
   * todo: should this just be called unmarshalled? it's only used in the unmarshall case at this
   * point todo: but it might be useful later in the marshall case as well...
   */
   ...
   * the JSON Object being processed.
   *
   * @param parent the parent ProcessedObject of this ProcessedObject, or null if this is the root
   *          of the Object hierarchy being processed.
   */
  ...
  /**
   * Set the source object that is being processed. This is the java object that is being marshalled
   * into json or the json object that is being unmarshalled into Java.
   *
  ...
  public List getLocation() {
    ...
    // todo: in many cases it's not needed! (it's only needed to cover circular reference and
    // duplicate objects)
