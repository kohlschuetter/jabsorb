...
public class AsyncSessionUtilTest extends TestCase {
  ...
  /**
   * Test method for
   * {@link com.kohlschutter.dumborb.client.async.AsyncSessionUtil#toSyncSession(com.kohlschutter.dumborb.client.async.AsyncSession)}.
   */
  ...
  /**
   * Test method for
   * {@link com.kohlschutter.dumborb.client.async.AsyncSessionUtil#toAsyncSession(com.kohlschutter.dumborb.client.Session)}.
   *
   * @throws Exception
   */
