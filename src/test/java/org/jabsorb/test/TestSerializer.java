...
public class TestSerializer extends TestCase {
  ...
  public void dontTestExtendedMaps() throws Exception {
    ...
    TestMap1 unmarshalled = (TestMap1) ser.unmarshall(unmarshallerState, TestMap1.class, json);
  ...
  public void dontTestMaps() throws Exception {
    ...
    System.out.println("Serialized: ");
    System.out.println(json.toString(2));
    HashMap/* <Integer, String> */ unmarshalled = (HashMap/* <Integer, String> */) ser.unmarshall(
        unmarshallerState, HashMap.class, json);
  ...
  public void testWaggle() throws Exception {
    ...
    JSONObject json1 = (JSONObject) ser.marshall(marshallerState, null, waggle, "waggle");
    ITest.Waggle unmarshalled = (ITest.Waggle) ser.unmarshall(unmarshallerState, ITest.Waggle.class,
        json1);
    assertEquals(waggle.toString(), unmarshalled.toString());
    marshallerState = new SerializerState();
    JSONObject json2 = (JSONObject) ser.marshall(marshallerState, null, unmarshalled, "waggle");
